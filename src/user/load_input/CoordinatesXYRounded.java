 ...
 * EOF
 */
public class CoordinatesXYRounded extends LoadAbstract{
	...
	sb.append("$1$:$9$:$2$:$10$:$3$:$6$:$4$:$7$:$8$:$11$:$5$");
	String[] a = sb.toString().split(":");
	double aux =0;
	for(int x=0; x< 11;x++ ) {
		if(x+1 == 11) {
			aux+=edgeCalc.calculate(a[0], a[10], JCLvars);
		}else {
			aux+=edgeCalc.calculate(a[x], a[x+1], JCLvars);
		}

	}
	System.out.println(Thread.currentThread().getName()+" value: "+aux);*/
}
